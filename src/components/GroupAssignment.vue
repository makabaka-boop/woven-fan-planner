...
import { Users, Clock, Package, Plus, Trash2, ChevronDown, ChevronUp, X } from 'lucide-vue-next';
...
<template>
  <div class="bg-white rounded-lg shadow-md p-4">
        ...
        <div class="bg-gradient-to-r from-green-50 to-emerald-50 px-4 py-3">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              ...
              <button
                @click="deleteConfirmGroupId = group.id"
    ...
    <Teleport to="body">
      <div
        v-if="deleteConfirmGroupId"
        class="fixed inset-0 bg-black/50 flex items-center justify-center z-50"
        @click.self="deleteConfirmGroupId = null"
      >
        <div class="bg-white rounded-lg shadow-xl w-full max-w-sm mx-4 overflow-hidden">
          <div class="px-4 py-3 bg-gradient-to-r from-red-600 to-red-500 text-white flex items-center justify-between">
            ...
            <button
              @click="deleteConfirmGroupId = null"
          ...
          <div class="p-4">
            <p class="text-gray-700">
              确定要删除「<span class="font-semibold">{{ groups.find(g => g.id === deleteConfirmGroupId)?.name }}</span>」吗？该小组的所有分配关系也将被移除，此操作不可撤销。
            </p>
            <div class="flex gap-2 mt-4">
              ...
              <button
                @click="emit('deleteGroup', deleteConfirmGroupId!); deleteConfirmGroupId = null"
